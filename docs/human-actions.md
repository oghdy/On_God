...
- [ ] **P0-S2-T1** 🧑 Supabase dev/prod 프로젝트 2개 생성 → URL·키·DB password 전달
- [ ] **P0-S2-T2** 🤝 `supabase login` 브라우저 인증, project ref 제공
- [ ] **P0-S2-T8** 🤝 마이그레이션 적용 시 CLI 인증/DB password 입력
- [ ] **P0-S3-T1** 🤝 타입 자동생성 위해 project ref·로그인 상태 제공
- [ ] **P0-S5-T4** 🧑 발급한 시크릿 값들을 `.env`/Supabase·Vercel·EAS에 입력
- [ ] **P0-S6-T3** 🤝 Expo 계정 생성·EAS 프로젝트 연결
- [ ] **P0-S6-T4** 🤝 Vercel에 GitHub 레포 연결, 환경변수 입력
- [ ] **(사전)** 🧑 GitHub 레포 생성 (또는 내가 `git init` 후 remote 연결)
